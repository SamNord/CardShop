...
export class DataService {
  categories = [
    ...
    },
    {
      id: 3,
      type: 'Epices',
      imageCat: 'assets/imagesCategory/epices3.jpeg',
    }
  ];
  ...
  produits = [
    ...
    {id :11, titre : 'Mangues', image : 'assets/fruits/mangue1.jpeg', prix : (2).toFixed(2), cat : 'Fruits'},
    ...
    {id :15, titre : 'Noix de coco', image : 'assets/fruits/noix_coco.jpeg', prix : (3.60).toFixed(2), cat : 'Fruits'},
    {id :16, titre : 'Oranges', image : 'assets/fruits/orange1.jpeg', prix : (2.65).toFixed(2), cat : 'Fruits'},
    {id :17, titre : 'Pastèques', image : 'assets/fruits/pasteque1.jpeg', prix : (3).toFixed(2), cat : 'Fruits'},
    {id :18, titre : 'Poires', image : 'assets/fruits/poires.jpg',prix : (2.30).toFixed(2), cat : 'Fruits'},
    {id :19, titre : 'Pommes', image : 'assets/fruits/pommes1.jpeg', prix : (2.50).toFixed(2), cat : 'Fruits'},
    {id :20, titre : 'Litchi', image : 'assets/fruits/litchi.jpg', prix : (3.80).toFixed(2), cat : 'Fruits'},
    {id :21, titre : 'Cannelle', image : 'assets/epices/cannelle1.jpeg', prix : (2).toFixed(2), cat : 'Epices'},
    ...
    {id :24, titre : 'Clous de girofles', image : 'assets/epices/girofles1.jpeg', prix : (1.70).toFixed(2), cat : 'Epices'},
    ...
    {id :28, titre : 'Safran', image : 'assets/epices/safran1.jpeg', prix : (4).toFixed(2), cat : 'Epices'},
    {id :29, titre : 'Artichauts', image : 'assets/legumes/artichauts1.jpeg', prix : (4.50).toFixed(2), cat : 'Légumes'},
    {id :30, titre : 'Batavia', image : 'assets/legumes/batavia1.jpeg', prix : (1.50).toFixed(2), cat : 'Légumes'},
    ...
    {id :35, titre : 'Fenouil', image : 'assets/legumes/fenuil1.jpeg', prix : (2).toFixed(2), cat : 'Légumes'},
    ...
    {id :38, titre : 'Navets', image : 'assets/legumes/navets1.jpeg', prix : (1.30).toFixed(2), cat : 'Légumes'},
    {id :39, titre : 'Oignons rouges', image : 'assets/legumes/oignons_rouges1.jpeg', prix : (1.70).toFixed(2), cat : 'Légumes'},
    {id :40, titre : 'Oignons', image : 'assets/legumes/oignons1.jpeg', prix : (1.50).toFixed(2), cat : 'Légumes'},
    ...
    {id :45, titre : 'Poivrons verts', image : 'assets/legumes/poivrons_verts1.jpeg', prix : (1.30).toFixed(2), cat : 'Légumes'},
